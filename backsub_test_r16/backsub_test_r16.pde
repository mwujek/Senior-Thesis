...
//list of static boundaries (left,right,bottom)
ArrayList<Boundary> boundaries;


//list of dynamic boundaries (motion sensing)
LiveSurface contourBoundaries;

//initiate box2d world
Box2DProcessing box2d;  


//openCV elements (bg snapshot, live video, openCV library)
PImage bg;
Capture video;
OpenCV opencv;

//OpenCV video is scaled down because the details are not necessary
...
//invincible and interactivity through the way that the ship interacts in the space.
