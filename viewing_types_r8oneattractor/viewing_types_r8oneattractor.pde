...
rightAttractorDefaulty =height - 200;
  ...
  eiAttractorLeftXpos = leftAttractorDefaultx;
  eiAttractorLeftYpos = leftAttractorDefaulty;
  snAttractorLeftXpos = leftAttractorDefaultx;
  snAttractorLeftYpos = leftAttractorDefaulty;
  tfAttractorLeftXpos = leftAttractorDefaultx;
  tfAttractorLeftYpos = leftAttractorDefaulty;
  jpAttractorLeftXpos = leftAttractorDefaultx;
  jpAttractorLeftYpos = leftAttractorDefaulty;
  eiAttractorRightXpos = leftAttractorDefaultx;
  eiAttractorRightYpos = leftAttractorDefaulty;
  snAttractorRightXpos = leftAttractorDefaultx;
  snAttractorRightYpos = leftAttractorDefaulty;
  tfAttractorRightXpos = leftAttractorDefaultx;
  tfAttractorRightYpos = leftAttractorDefaulty;
  jpAttractorRightXpos = leftAttractorDefaultx;
  jpAttractorRightYpos = leftAttractorDefaulty;
  ...
  bgLeft = new PImage((width/scaleFactorW)/2, height/scaleFactorH);
  ...
  video = new Capture(this, (width/scaleFactorW)/2, height/scaleFactorH, "USB_Camera");
...
void draw() {
  ...
  for (int i = 0; i < senseIntuitionLeft.size()-1; i++) {
    // Look, this is just like what we had before!
    Vec2 force = eiAttractorLeft.attract(senseIntuitionLeft.get(i));
  ...
  for (int i = 0; i < thinkFeelLeft.size()-1; i++) {
    // Look, this is just like what we had before!
    Vec2 force = eiAttractorLeft.attract(thinkFeelLeft.get(i));
  ...
  for (int i = 0; i < judgePerceptionLeft.size()-1; i++) {
    // Look, this is just like what we had before!
    Vec2 force = eiAttractorLeft.attract(judgePerceptionLeft.get(i));
  ...
  for (int i = 0; i < senseIntuitionRight.size()-1; i++) {
    // Look, this is just like what we had before!
    Vec2 force = eiAttractorRight.attract(senseIntuitionRight.get(i));
  ...
  for (int i = 0; i < thinkFeelRight.size()-1; i++) {
    // Look, this is just like what we had before!
    Vec2 force = eiAttractorRight.attract(thinkFeelRight.get(i));
  ...
  for (int i = 0; i < judgePerceptionRight.size()-1; i++) {
    // Look, this is just like what we had before!
    Vec2 force = eiAttractorRight.attract(judgePerceptionRight.get(i));
