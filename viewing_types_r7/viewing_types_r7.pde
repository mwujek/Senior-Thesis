...
//pushMatrix();
  ...
  bgLeft = new PImage((width/scaleFactorW), height/scaleFactorH);
...
//  translate(300,-100);
  ...
  opencv.inRange(150, 255);  //Pixels within this range are made white, others made black
...
//RIGHT SIDE ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //image(opencv.getSnapshot(), 48, 0); //Right Side
