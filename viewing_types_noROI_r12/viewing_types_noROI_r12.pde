...
//old
AttractorLeft eiAttractorLeft;
AttractorLeft snAttractorLeft;
AttractorLeft tfAttractorLeft;
AttractorLeft jpAttractorLeft;

AttractorRight eiAttractorRight;
AttractorRight snAttractorRight;
AttractorRight tfAttractorRight;
AttractorRight jpAttractorRight;
...
if(restartValue==1.0){
  ...
  if (bgRefresh || toggleTrue) {
    ...
    addedMarginL=abs(eiLeftSaturation)/2;
    }  
