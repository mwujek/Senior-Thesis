...
float decreaseOpacitySpeed =  0.6;
...
jpAttractorRightYpos = height - 200;
  ...
  //setup Attractors
  eiAttractorLeft = new Attractor(12, eiAttractorLeftXpos, eiAttractorLeftYpos);
  snAttractorLeft = new Attractor(12, snAttractorLeftXpos, snAttractorLeftYpos);
  tfAttractorLeft = new Attractor(12, tfAttractorLeftXpos, tfAttractorLeftYpos );
  jpAttractorLeft = new Attractor(12, jpAttractorLeftXpos, jpAttractorLeftYpos);

  eiAttractorRight = new Attractor(12, eiAttractorRightXpos, eiAttractorRightYpos);
  snAttractorRight = new Attractor(12, snAttractorRightXpos, snAttractorRightYpos);
  tfAttractorRight = new Attractor(12, tfAttractorRightXpos, tfAttractorRightYpos);
  jpAttractorRight = new Attractor(12, jpAttractorRightXpos, jpAttractorRightYpos);
}
