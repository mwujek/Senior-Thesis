...
class Circle {
  ...
  void displayEILeft() {
    ...
    noStroke();
    //image(img, 0, 0);
    fill(redLeft, abs(eiLeftSaturation)*255, blueLeft, opacity); //blue
  ...
  void displaySNLeft() {
    ...
    noStroke();
    //image(img, 0, 0);
    fill(255, abs(snLeftSaturation)*255, 255, opacity); //blue
    opacity--;
  ...
  void displayTFLeft() {
    ...
    noStroke();
    //image(img, 0, 0);
    fill(redLeft, abs(tfLeftSaturation)*255, greenLeft, opacity);
    opacity-=decreaseOpacitySpeed;
...
//This controls Judging and Perception
  void displayJPLeft() {
    ...
    noStroke();
    //image(img, 0, 0);
    fill(blueLeft, abs(jpLeftSaturation)*255, redLeft, opacity); //blue
    opacity-=decreaseOpacitySpeed;
...
//RIGHT SIDE------------------------------------------------------------------------------------------------
    ...
    noStroke();
    //image(img, 0, 0);
    fill(redRight, abs(eiRightSaturation)*255, 255, opacity); //blue
    opacity-=decreaseOpacitySpeed;
  ...
  void displaySNRight() {
    ...
    noStroke();
    //image(img, 0, 0);
    fill(greenRight, abs(snRightSaturation)*255, 255, opacity); //blue
    opacity--;
  ...
  void displayTFRight() {
    ...
    noStroke();
    //image(img, 0, 0);
    fill(redRight, abs(tfRightSaturation)*255, 255, opacity);
    opacity-=decreaseOpacitySpeed;
...
//This controls Judging and Perception
  void displayJPRight() {
    ...
    noStroke();
    //image(img, 0, 0);
    fill(blueRight, abs(jpRightSaturation)*255, 255, opacity); //blue
    opacity-=decreaseOpacitySpeed;
